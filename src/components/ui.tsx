...
export function SignInModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[90] bg-black/70 p-4 backdrop-blur-sm" role="dialog" aria-modal="true">
      <div className="card absolute top-1/2 left-1/2 w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 -translate-y-1/2 p-5">
