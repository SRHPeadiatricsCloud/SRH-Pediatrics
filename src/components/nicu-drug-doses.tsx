...
export function NicuDrugDoses() {
  ...
  return <div className="dose-workspace">
    <section className="dose-hero"><div><span className="dose-kicker">NICU formulary · digitised from supplied chart</span><h1>Drugs &amp; doses</h1><p>Weight-based amount and volume to draw up.</p></div><span className="dose-safety"><ShieldAlert size={15} /> Verify before prescribing</span></section>
    ...
    <details className="dose-disclaimer quiet"><summary><ShieldAlert size={17} /><b>Clinical safety</b></summary><p>Transcription and calculation aid from the supplied NICU dose chart, not an independent prescribing protocol. Confirm indication, current weight, gestational/postmenstrual age, renal/hepatic function, allergy status, dilution, route, maximum dose, drug levels and local antimicrobial policy. Aminoglycosides and vancomycin need particular attention to levels and renal function. A second clinician or pharmacist should verify high-risk doses before administration.</p></details>
  </div>;
}
