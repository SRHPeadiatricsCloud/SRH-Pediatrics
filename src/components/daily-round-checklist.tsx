  ...
  switch (state) {
    case "done":
      return {
        ...
        chipCls: "border-emerald-500/40 text-slate-200",
        tag: "DONE",
      };
    case "overdue":
      return {
    ...
    case "na":
      return {
        ...
        chipCls: "border-white/10 text-slate-400",
        tag: "N/A",
      };
  }
}
    ...
    <div className="rounded-xl border border-slate-800/80 bg-slate-900/60 p-3.5 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800/60 pb-2.5">
        ...
        <div className="flex items-center gap-2 text-[11px]">
          ...
          {round.outstanding === 0 ? (
            <span className="rounded-full border border-emerald-500/30 px-2 py-0.5 font-semibold text-slate-300">
              Round complete
            </span>
          ) : (
