...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      { src: "/icons/icon-512.png?v=4.1.2", sizes: "512x512", type: "image/png", purpose: "any" },
      { src: "/icons/icon-512.png?v=4.1.2", sizes: "512x512", type: "image/png", purpose: "maskable" },
      { src: "/images/hospital-logo.png?v=4.1.2", sizes: "539x371", type: "image/png" },
    ],
  };
}
