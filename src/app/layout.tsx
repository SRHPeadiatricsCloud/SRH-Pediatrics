...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: "/icons/icon-512.png?v=2.0.026", sizes: "512x512", type: "image/png" }],
    apple: [{ url: "/icons/icon-512.png?v=2.0.026", sizes: "512x512", type: "image/png" }],
  },
};
      ...
      <body style={fontVars} className="text-slate-100 antialiased">
        ...
        <footer className="no-print border-t border-white/5 py-5 text-center">
          <div className="mb-2 flex justify-center">
            ...
            <img
              src="/images/hospital-logo.png?v=2.0.026"
